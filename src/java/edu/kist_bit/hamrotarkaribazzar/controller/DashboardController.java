 ...
 */
@WebServlet(name = "DashboardController", urlPatterns = {"/dashboard","/aboutus","/contact","/shop","/cart"})
        ...
        switch(servletPath){
            case "/dashboard" :
               ...
               // System.out.println(category);
                ...
                redirectURL = "/WEB-INF/dashboard.jsp";
                break;
                
            case "/aboutus" :                
                redirectURL = "/WEB-INF/aboutus.jsp";
                break;
                
            case "/contact" :
                redirectURL = "/WEB-INF/contact.jsp";
                break;
             
            case "/shop" :
                redirectURL = "WEB-INF/shop.jsp";
                break;
                
            case "/cart" :
                redirectURL = "WEB_INF/cart.jsp";
