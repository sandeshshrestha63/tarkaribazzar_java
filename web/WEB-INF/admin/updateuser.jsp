<%-- 
    Document   : updateuser
    Created on : Nov 28, 2019, 9:24:09 PM
                 ...
                 <div class="span12">
                     ...
                     <div class="widget green">
                         <div class="widget-title">
                             <h4><i class=" icon-user"></i> Update User </h4>
                         </div>
                         <div class="widget-body form">
                             <!-- BEGIN FORM-->
                             <form id="validate_form" action="updateuser" method="POST" class="cmxform form-horizontal" enctype="multipart/form-data"> 
                              ...
                              <div class="form-group">
                                  <div class="controls">
                                      <img class="img-thumbnail" src="${user.image}" alt="img" width="10%" height="10%">
                                  </div>
                              </div> 
                              <br>
                              <div class="control-group ">
                                  ...
                                  <div class="controls ">
                                      <input type="text" name="fname" id="first_name" placeholder="First Name" value="${user.fname}" required data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup" class="span6" />
                                  </div>
                              </div>
                              <div class="control-group ">
                                  <label for="lastname" class="control-label">LastName</label>
                                  <div class="controls ">
                                      <input type="text" name="lname" id="last_name" placeholder="Last Name" value="${user.lname}" required data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup" class="span6" />
                                  </div>
                              </div>
                              <div class="control-group ">
                                  <label for="username" class="control-label">Username</label>
                                  <div class="controls ">
                                      <input type="text" name="username" id="username" placeholder="Username" value="${user.username}" required data-parsley-pattern="^[a-zA-Z0-9]+$" data-parsley-trigger="keyup" class="span6" />
                                  </div>
                              </div>
                              <div class="control-group ">
                                  <label for="password" class="control-label">Password</label>
                                  <div class="controls ">
                                      <input type="password" name="password" id="password" placeholder="Password" value="${user.password}" required data-parsley-length="[8, 16]" data-parsley-trigger="keyup" class="span6" />
                                  </div>
                              </div>
                              <div class="control-group ">
                              ...
                              <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="address" id="address" placeholder="Address" value="${user.address}" required data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup" class="span6" />
                                    </div>
                                </div>
                                <div class="control-group ">
                                    <label for="contact" class="control-label">Contact</label>
                                    <div class="controls">
                                        <input type="text" name="phone" id="contact" placeholder="Contact Number" value="${user.phone}" required data-parsley-pattern="^[0-9]+$" data-parsley-trigger="keyup" class="span6" />
                                    </div>
                                </div>
                                <div class="control-group">
                              ...
                              <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="city" id="contact" placeholder="City" value="${user.city}" required data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup" class="span6" />
                                    </div>
                                </div>
                              <div class="control-group ">
                                    <label for="contact" class="control-label">State</label>
                                    <div class="controls">
                                        <input type="text" name="state" id="contact" placeholder="State" value="${user.state}" required data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup" class="span6" />
                                    </div>
                                </div>
                              <div class="control-group ">
                                    <label for="contact" class="control-label">Country</label>
                                    <div class="controls">
                                        <input type="text" name="country" id="contact" placeholder="Country" value="${user.country}" required data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup" class="span6" />
                                    </div>
                                </div>
<!--                                <div class="control-group">
