<%-- 
    ...
    Created on : Nov 30, 2019, 9:12:15 PM
    Author     : User
--%>
...
<!--                                <th class="hidden-phone">S.No.</th>-->
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    ...
                                    <a href="updateproduct?ref=${product.id}" class="btn btn-primary"><i class="icon-pencil"></i></a>
                        ...
                        <div id="deleteconfirm" style="background-color: #F0F0F0;" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">                        
                            <div class="modal-body">
                                <p style="font-size: 25px; color: red;"><i class="icon-remove-sign"> Are you sure you want to delete this Product??????</i></p>
                            </div>
